...
func (in *MinerStatus) DeepCopyInto(out *MinerStatus) {
	*out = *in
	if in.WindowPostSchedule != nil {
		in, out := &in.WindowPostSchedule, &out.WindowPostSchedule
		*out = make(WindowPostSchedule, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in WindowPostSchedule) DeepCopyInto(out *WindowPostSchedule) {
	{
		in := &in
		*out = make(WindowPostSchedule, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WindowPostSchedule.
func (in WindowPostSchedule) DeepCopy() WindowPostSchedule {
	if in == nil {
		return nil
	}
	out := new(WindowPostSchedule)
	in.DeepCopyInto(out)
	return *out
}
