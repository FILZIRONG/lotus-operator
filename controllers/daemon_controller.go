...
// DaemonReconciler reconciles a Daemon object
...
// +kubebuilder:rbac:groups=lotus.filecoin.io,resources=daemons,verbs=get;list;watch;create;update;patch;delete
...
// the Daemon object against the actual cluster state, and then
